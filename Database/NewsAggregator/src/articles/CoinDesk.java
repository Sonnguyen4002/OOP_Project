...
public class CoinDesk extends WebScraper {
...
//        }
    ...
    protected void extractArticleDetails(Document doc) {
        ...
        summary = doc.select("h2").text().isEmpty() ? "N/A" : doc.select("h2").text();
        ...
        category = doc.select("meta[property=article:section]").attr("content");
